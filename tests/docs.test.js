...
test('all thirteen real-world templates compile and old starters are gone', () => {
  ...
  const entries = fs.readdirSync(root)
    ...
    .sort();
  if (entries.length !== 13) throw new Error(`expected 13 templates, found ${entries.length}`);
