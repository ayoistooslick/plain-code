# PlainScript 1.0.0-latest — Capability-Gap Audit vs. TypeScript / Node.js
...
>
> This document is the complete working audit for the 1.0.0-latest milestone. For every
> major TypeScript/Node.js capability area, it records:
>
> - **Status** — what PlainScript 1.0.0-latest already does,
...
>
> **Gate:** PlainScript must NOT be declared 1.0.0-latest "ready" until this audit is
...
## 21. 1.0.0-latest readiness gate
...
Until then the package version remains **below 1.0.0-latest**.

---

## 22. v2.2.0 — AI/ML, data/storage & web additions

The v2.0–v2.2 releases close further gaps beyond the 1.0.0-latest audit across the
