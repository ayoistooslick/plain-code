# PlainScript 1.0.0 — Capability-Gap Audit vs. TypeScript / Node.js
...
>
> This document is the complete working audit for the 1.0.0 milestone. For every
> major TypeScript/Node.js capability area, it records:
>
> - **Status** — what PlainScript 1.0.0 already does,
...
>
> **Gate:** PlainScript must NOT be declared 1.0.0 "ready" until this audit is
