...
var LIBRARY = [
  ...
  {cat:"types",name:"Type Annotations",desc:"Add types to variables for documentation (stripped at compile time)",ps:'remember name of type text as "Hello"\nremember age of type number as 25\nremember active of type "yes or no" as true',js:'let name = "Hello";\nlet age = 25;\nlet active = true;'},
  {cat:"types",name:"Shape (Interface)",desc:"Define object structures with shapes (compiled to JSDoc)",ps:'shape User\n  name is text\n  maybe age is number\n  email is text\ndone',js:'/** @typedef {{ name: any, age: any, email: any }} User */'},
  {cat:"types",name:"Shape with Methods",desc:"Define class-like structures with constructor and prototype methods",ps:'shape User\n  name is text\n  age is number\n  make greet()\n    show `Hello, ${name}!`\n  done\ndone',js:'function User(name, age) {\n  this.name = "";\n  this.age = 0;\n}\nUser.prototype.greet = function() {\n  console.log(`Hello, ${this.name}!`);\n};'},
  {cat:"types",name:"Abstract Classes",desc:"Define base classes that cannot be instantiated directly",ps:'abstract shape Shape\n  make area()\n    show 0\n  done\ndone',js:'function Shape() {\n  if (new.target === Shape) throw new Error("Cannot instantiate abstract class Shape");\n}\nShape.prototype.area = function() {\n  console.log(0);\n};'},
  {cat:"types",name:"Type Aliases",desc:"Create named type shortcuts",ps:'define ID as text or number\ndefine Status as "active" or "inactive" or "pending"',js:'/** @typedef {text or number} ID */\n/** @typedef {"active" or "inactive" or "pending"} Status */'},
  {cat:"types",name:"Enums",desc:"Define a set of named constants",ps:'define Direction as one of\n  up\n  down\n  left\n  right\ndone\n\nshow Direction.up',js:'const Direction = { "up": 0, "down": 1, "left": 2, "right": 3 };\nconst { up, down, left, right } = Direction;\n\nconsole.log(up);'},
  {cat:"types",name:"Optional Properties",desc:"Mark shape properties as optional with maybe",ps:'shape Config\n  host is text\n  maybe port is number\n  maybe debug is "yes or no"\ndone',js:'/** @typedef {{ host: any, port?: any, debug?: any }} Config */'},
  {cat:"types",name:"Hidden (Private) Members",desc:"Mark shape properties and methods as private",ps:'shape Account\n  name is text\n  hidden password is text\n  hidden login()\n    show "logging in"\n  done\ndone',js:'function Account(name) {\n  this.name = "";\n  this.password = null;\n}\n/** @private */ Account.prototype.login = function() {\n  console.log("logging in");\n};'},
  {cat:"types",name:"Frozen (Readonly) Properties",desc:"Mark shape properties as read-only",ps:'shape User\n  frozen id is text\n  name is text\ndone',js:'/** @typedef {{ id: any, name: any }} User */'},
  {cat:"types",name:"Return Type Annotations",desc:"Specify return types on functions (stripped at compile time)",ps:'make add(a, b) returning number\n  give a + b\ndone',js:'function add(a, b) {\n  return a + b;\n}'},
  {cat:"types",name:"Generics",desc:"Write type-parameterized functions with sort keyword",ps:'make identity(the value of any sort) giving back value\n  give value\ndone',js:'(value) => value'},
  {cat:"types",name:"Type Guards",desc:"Check the runtime type of a value",ps:'remember x as "hello"\nif x is a text\n  show "string!"\ndone',js:'let x = "hello";\nif (typeof x === "string") {\n  console.log("string!");\n}'},
  {cat:"types",name:"Partial (All Optional)",desc:"Make all shape properties optional",ps:'shape User\n  name is text\n  age is number\n  email is text\ndone\n\npartial User as UpdateUser',js:'/** @typedef {{ name?: any, age?: any, email?: any }} UpdateUser */'},
  {cat:"functions",name:"Arrow Functions",desc:"Create concise anonymous functions",ps:'remember double as make(x) giving back x * 2\nshow double(5)',js:'let double = (x) => x * 2;\nconsole.log(double(5));'},
  {cat:"functions",name:"Destructuring",desc:"Extract values from objects and arrays",ps:'remember user as\n  name is "Ayo"\n  age is 25\ndone\n\nremember { name, age } from user\nshow name\nshow age',js:'let user = {\n  "name": "Ayo",\n  "age": 25\n};\n\nconst { name, age } = user;\nconsole.log(name);\nconsole.log(age);'},
  {cat:"functions",name:"Array Destructuring",desc:"Extract values from arrays with optional rest",ps:'remember items as [1, 2, 3, 4, 5]\nremember [first, ...rest] from items\nshow first\nshow rest',js:'let items = [1, 2, 3, 4, 5];\nconst [first, ...rest] = items;\nconsole.log(first);\nconsole.log(rest);'},
  {cat:"functions",name:"Spread Operator",desc:"Expand arrays or objects inline",ps:'remember a as [1, 2, 3]\nremember b as [4, 5, 6]\nremember combined as [everything from a, everything from b]',js:'let a = [1, 2, 3];\nlet b = [4, 5, 6];\nlet combined = [...a, ...b];'},
  {cat:"booleans",name:"Optional Chaining",desc:"Safely access nested properties that may not exist",ps:'remember city as the city of the address of user (or empty)\nshow city',js:'let city = user?.address?.city;\nconsole.log(city);'},
  {cat:"booleans",name:"Nullish Coalescing",desc:"Provide a default when a value is null or undefined",ps:'remember port as the port of config (or else 3000)\nshow port',js:'let port = config?.port ?? 3000;\nconsole.log(port);'},
  {cat:"ai",name:"OCR (Optical Character Recognition)",desc:"Extract text from images using Tesseract OCR",ps:'ocr "screenshot.png" as extractedText\nshow extractedText\n\nocr "receipt.jpg" using "eng+fra" as receiptText',js:'let extractedText = await ocrImage("screenshot.png", "eng");\nconsole.log(extractedText);\n\nlet receiptText = await ocrImage("receipt.jpg", "eng+fra");'},
];
